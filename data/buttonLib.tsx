...
// CURATED COLLECTION - CORE BUTTONS ONLY (60 TOTAL)
...
import { design as microZoom } from '../components/buttons/MagnifyHover';
...
import { design as hardStamp } from '../components/buttons/NeumorphicEmbossed';
...
import { design as arcadeStick } from '../components/buttons/RetroJoystick';
import { design as retro3d } from '../components/buttons/Retro3D';
import { design as sketchyArchitecture } from '../components/buttons/HandDrawn';
import { design as neonBorder } from '../components/buttons/NeonBorder';
import { design as pearlHolo } from '../components/buttons/Holographic';
import { design as meshFlow } from '../components/buttons/CyberGradient';
import { design as chromaBorder } from '../components/buttons/RainbowBorder';
import { design as whirlpoolConic } from '../components/buttons/GradientConic';
import { design as starVoid } from '../components/buttons/InnerGlowPill';
import { design as chromaPeak } from '../components/buttons/RainbowText';
import { design as hotShimmer } from '../components/buttons/Shimmer';
...
import { design as centerPillFill } from '../components/buttons/PillOutlineFill';
...
import { design as subtleGhost } from '../components/buttons/GhostReveal';
import { design as monoExpansion } from '../components/buttons/TextScramble';
import { design as industrialPlate } from '../components/buttons/IndustrialPlate';
import { design as strikeReveal } from '../components/buttons/TextStrikethrough';
import { design as floatingLabel } from '../components/buttons/FloatingLabel';
import { design as smallIndicator } from '../components/buttons/IndicatorButton';
import { design as glitchCyber } from '../components/buttons/GlitchEffect';
import { design as stackedLayers } from '../components/buttons/StackedLayers';
import { design as dreamyBlur } from '../components/buttons/EtherealBlur';
import { design as organicBlob } from '../components/buttons/GooeyButton';
import { design as origamiReveal } from '../components/buttons/PaperFold';

export const buttonLibrary: ButtonDesign[] = [
  // PRODUCTION-READY CURATED COLLECTION - 60 BUTTONS
  claySoftPill,
  neoHardShadow,
  retroCassette,
  disabledButton,
