...
const Packages: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-brand-dark text-brand-light">
      {/* Header */}
      <Header onNavigateHome={() => {}} onNavigate={() => {}} />
        ...
        <div className="mb-8 md:mb-12">
          <div className="flex items-center gap-2 mb-4 justify-center md:justify-start">
            <h1 className="text-2xl md:text-5xl font-black tracking-tight">
              Coolbuttons <span className="text-orange-500">Packages</span>
            </h1>
          </div>
          <p className="text-sm md:text-base text-zinc-400 max-w-2xl mx-auto md:mx-0 text-center md:text-left">
            Production-ready button components for React, Vanilla JavaScript, and any framework. Install, import, and ship.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6 md:gap-8 mb-8 md:mb-12">
          ...
          <div className="relative h-full bg-zinc-900/50 border border-zinc-800 rounded-lg md:rounded-xl p-6 md:p-8 hover:border-orange-500/50 transition-all hover:shadow-lg hover:shadow-orange-500/10">
            ...
            <div className="flex items-start justify-between mb-6">
              <div>
                <div className="mb-4 w-16 h-16 rounded-lg overflow-hidden flex items-center justify-center">
                  <img src="/favicon/favicon.svg" alt="Cool Buttons" className="w-full h-full object-cover" />
                </div>
                <h2 className="text-xl md:text-2xl font-black mb-2">coolbuttons</h2>
              </div>
            </div>
            ...
            <div className="flex flex-wrap gap-2 mb-6">
              <div className="bg-zinc-700 text-zinc-300 px-3 py-1 rounded text-xs font-mono">
                npm <span className="bg-orange-600 text-white px-2 rounded ml-1">v1.0.2</span>
              </div>
            </div>

            {/* Description */}
            <p className="text-sm md:text-base text-zinc-300 mb-6 leading-relaxed">
              Universal package with all components. Works with React, Vue, Svelte, Vanilla JS, and any framework.
            </p>

            {/* Action Buttons */}
            <div className="flex gap-3">
              <a
                href="https://www.npmjs.com/package/coolbuttons"
                target="_blank"
          ...
          <div className="relative h-full bg-zinc-900/50 border border-zinc-800 rounded-lg md:rounded-xl p-6 md:p-8 hover:border-orange-500/50 transition-all hover:shadow-lg hover:shadow-orange-500/10">
            ...
            {/* Description */}
            <p className="text-sm md:text-base text-zinc-300 mb-6 leading-relaxed">
              400+ production-ready button components for React applications.
            </p>
          ...
          <div className="relative h-full bg-zinc-900/50 border border-zinc-800 rounded-lg md:rounded-xl p-6 md:p-8 hover:border-orange-500/50 transition-all hover:shadow-lg hover:shadow-orange-500/10">
            ...
            <div className="flex items-start justify-between mb-6">
              <div>
                <div className="mb-4 w-16 h-16 bg-yellow-500/20 rounded-lg flex items-center justify-center">
                  <svg className="w-10 h-10" viewBox="0 0 122.88 122.88" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <polygon points="0,0 122.88,0 122.88,122.88 0,122.88 0,0" fill="#F7DF1E"/>
                    <path d="M32.31,102.69l9.4-5.69c1.81,3.22,3.46,5.94,7.42,5.94c3.79,0,6.19-1.48,6.19-7.26V56.41h11.55v39.43 c0,11.96-7.01,17.4-17.24,17.4C40.39,113.24,35.03,108.46,32.31,102.69L32.31,102.69L32.31,102.69z M73.14,101.45l9.4-5.44 c2.48,4.04,5.69,7.01,11.38,7.01c4.78,0,7.84-2.39,7.84-5.69c0-3.96-3.13-5.36-8.41-7.67l-2.89-1.24c-8.33-3.55-13.86-8-13.86-17.4 c0-8.66,6.6-15.26,16.91-15.26c7.34,0,12.62,2.56,16.41,9.24l-8.99,5.77c-1.98-3.55-4.12-4.95-7.42-4.95 c-3.38,0-5.53,2.14-5.53,4.95c0,3.46,2.14,4.87,7.09,7.01l2.89,1.24c9.82,4.21,15.34,8.5,15.34,18.15 c0,10.39-8.17,16.08-19.14,16.08C83.45,113.25,76.52,108.13,73.14,101.45L73.14,101.45L73.14,101.45z M73.14,101.45L73.14,101.45 L73.14,101.45L73.14,101.45z" fill="black"/>
                  </svg>
                </div>
            ...
            <div className="flex flex-wrap gap-2 mb-6">
              <div className="bg-zinc-700 text-zinc-300 px-3 py-1 rounded text-xs font-mono">
                npm <span className="bg-orange-600 text-white px-2 rounded ml-1">v1.0.1</span>
              </div>
            </div>

            {/* Description */}
            <p className="text-sm md:text-base text-zinc-300 mb-6 leading-relaxed">
              400+ production-ready button components for vanilla JavaScript.
            </p>
